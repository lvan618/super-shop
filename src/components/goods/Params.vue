          ...
          <el-table :data="manyTableDate" border stripe>
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                <el-button size="mini" type="danger" class="el-icon-delete" @click="removePrams(scope.row.attr_id)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    showInput(row) {
      ...
      // 文本框自动获得焦点
      // $nextTick方法作用，是页面上元素重新渲染后，才会指定回调函数中的代码
      this.$nextTick(_ => {
